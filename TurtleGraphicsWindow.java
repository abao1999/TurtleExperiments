 ...
 * programming in Java.
 */
public class TurtleGraphicsWindow extends Frame implements TGKeyHandler, TGMouseHandler, WindowListener	{
    ...
    */
   public final static int DEFAULT_CANVAS_HEIGHT = 850;

   /**
    * Default width of the graphics canvas.
    */
   public final static int DEFAULT_CANVAS_WIDTH = 850;
    ...
    */
   public TurtleGraphicsWindow( int DEFAULT_CANVAS_WIDTH, int DEFAULT_CANVAS_HEIGHT )
   {
